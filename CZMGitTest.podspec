...
Pod::Spec.new do |s|
  ...
  s.name         = "CZMGitTest"
  s.version      = "0.0.1"
  s.summary      = "A short description of CZMGitTest."
 ...
 #
  ...
  # Or just: s.author    = "caizhongming"
  # s.authors            = { "caizhongming" => "cai.zhongming@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/caizhongming"
